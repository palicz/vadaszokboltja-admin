...
export const BillboardForm: React.FC<BillboardFormProps> = ({
    ...
    const title = initialData ? "Plakát szerkesztése" : "Plakát létrehozása";
    const description = initialData ? "Kijelölt plakát szerkesztése" : "Egy új plakát hozzáadása";
    const toastMessage = initialData ? "Plakát sikeresen frissítve." : "Plakát sikeresen létrehozva.";
                    ...
                    <div className="grid grid-cols-3 gap-8">
                        <FormField control={form.control} name="label" render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input disabled={loading} placeholder="Plakát felirat" {...field} />
                                </FormControl>
                            </FormItem>
                        )} />
                    </div>
