...
export const BrandForm: React.FC<BrandFormProps> = ({
    ...
    const title = initialData ? "Márka szerkesztése" : "Márka létrehozása";
    const description = initialData ? "Kijelölt márka szerkesztése" : "Egy új márka hozzáadása";
    const toastMessage = initialData ? "Márka sikeresen frissítve." : "Márka sikeresen létrehozva.";
    ...
    const onDelete = async () => {
        try {
            ...
            toast.error("Először győződjön meg arról, hogy eltávolított minden terméket, ami ezt a márkát használja.")
        } finally {
            setLoading(false)
            setOpen(false)
        }
